...
function ExampleSkeleton(props: ExampleSkeletonProps) {
  ...
  return <div className="example-skeleton" style={style}></div>;
}

function ExampleIcon(props: { size: string; color: string }) {
  const size = props.size;
  const color = props.color;
...
function ExampleTopBar(props: { hamburgerClick: any; hamburgerActive: any }) {
...
function ExampleSideBarLink(props: { chars: any }) {
  const chars = props.chars;
...
function ExampleSideBar(props: { expanded: any }) {
...
function ExampleBreadcumbLink(props: { chars: any }) {
  const chars = props.chars;
...
function ExamplePanelContent(props: { titleChars: string; lines: string }) {
  const { titleChars, lines } = props;
